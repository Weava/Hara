...
namespace Hara {
    ...
    MSWindow::MSWindow(const WindowProps& props) { init(props); }

    MSWindow::~MSWindow() { shutdown(); }
    ...
    void MSWindow::init(const WindowProps& props) {
        ...
        CORE_LOG_INFO("Creating window {0} {1} {2}", props.title, props.width,
                      props.height);
        ...
        window = glfwCreateWindow((int)windowData.width, (int)windowData.height,
    ...
    void MSWindow::shutdown() { glfwDestroyWindow(window); }
    ...
    void MSWindow::setVSync(bool enabled) {
        ...
        windowData.isVSyncEnabled = enabled;
    }

    bool MSWindow::isVSyncEnabled() const { return windowData.isVSyncEnabled; }
