...
//  2025-02-18: OpenGL: Lazily reinitialize embedded GL loader for when calling
//  backend from e.g. other DLL boundaries. (#8406) 2024-10-07: OpenGL: Changed
//  default texture sampler to Clamp instead of Repeat/Wrap. 2024-06-28: OpenGL:
//  ImGui_ImplOpenGL3_NewFrame() recreates font texture if it has been destroyed
//  by ImGui_ImplOpenGL3_DestroyFontsTexture(). (#7748) 2024-05-07: OpenGL:
//  Update loader for Linux to support EGL/GLVND. (#7562) 2024-04-16: OpenGL:
//  Detect ES3 contexts on desktop based on version string, to e.g. avoid
//  calling glPolygonMode() on them. (#7447) 2024-01-09: OpenGL: Update GL3W
//  based imgui_impl_opengl3_loader.h to load "libGL.so" and variants, fixing
...
void ImGui_ImplOpenGL3_NewFrame() {
    ...
    ImGui_ImplOpenGL3_InitLoader();  // Lazily init loader if not already done
                                     // for e.g. DLL boundaries.
